...
processes across 8 cores, with subprogress divided into 5 intervals.
...
ETA is approximate. As part of minimising overhead, it is only updated with each
change in progress (i.e. each time a block of processes completes) or when
subprogress changes. It is not updated by interrupt.
